...
import { slideInLeft, slideInRight, slideInTop, slideInBottom } from "../_common/utils/presets"
...
export default function Drawer({ placement = "right", children, ...props }: IDrawerProps) {
