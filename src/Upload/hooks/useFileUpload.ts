...
type IUseFileUploadProps = Pick<IFileUploadProps, "fileList" | "maxCount" | "onChange">

export default function useFileUpload({ onChange, fileList = [], maxCount }: IUseFileUploadProps) {
