...
function UploadArea({ width, height, onDrop, onChange, uploadIcon, multiple }: IUploadAreaProps, ref: any) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex items-center justify-center" onClick={() => uploadRef.current?.click()}>
        <>{uploadIcon}</>
        <input
          style={{ display: "none" }}
          multiple={multiple}
